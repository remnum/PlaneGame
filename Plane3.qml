...
Node {
    ...
    Model {
        id: plane2
        source: "file:./asset_imports/Quick3DAssets/Plane3/meshes/plane2.mesh"

        PrincipledMaterial {
            id: node14082_WWII_Plane_Japan_Kawasaki_Ki_61_body_01_material
            baseColorMap: Texture {
                source: "file:./asset_imports/Quick3DAssets/Plane3/maps/0.png"
    ...
    Model {
        ...
        y: 0.0383161
        z: 0.002
        source: "file:./asset_imports/Quick3DAssets/Plane3/meshes/router.mesh"
        materials: [
            node14082_WWII_Plane_Japan_Kawasaki_Ki_61_body_01_material
        ]
